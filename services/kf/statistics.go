...
const (
	FGetCorpStatisticURL = "/cgi-bin/kf/get_corp_statistic"
	FGetServicerStatisticURL = "/cgi-bin/kf/get_servicer_statistic"
)
...
func (s *Service) GetCorpStatistic(ctx context.Context, req *kf.GetCorpStatisticRequest) (*kf.GetCorpStatisticResponse, error) {
	return client.PostAndUnmarshal[kf.GetCorpStatisticResponse](s.client, ctx, FGetCorpStatisticURL, req)
}
...
func (s *Service) GetServicerStatistic(ctx context.Context, req *kf.GetServicerStatisticRequest) (*kf.GetServicerStatisticResponse, error) {
	return client.PostAndUnmarshal[kf.GetServicerStatisticResponse](s.client, ctx, FGetServicerStatisticURL, req)
}
