...
const (
	FCustomerBatchgetURL = "/cgi-bin/kf/customer/batchget"
	FCustomerCancelUpgradeServiceURL = "/cgi-bin/kf/customer/cancel_upgrade_service"
	FCustomerGetUpgradeServiceConfigURL = "/cgi-bin/kf/customer/get_upgrade_service_config"
	FCustomerUpgradeServiceURL = "/cgi-bin/kf/customer/upgrade_service"
)
...
func (s *Service) BatchGetCustomer(ctx context.Context, req *kf.BatchGetCustomerRequest) (*kf.BatchGetCustomerResponse, error) {
	return client.PostAndUnmarshal[kf.BatchGetCustomerResponse](s.client, ctx, FCustomerBatchgetURL, req)
}
...
func (s *Service) GetUpgradeServiceConfig(ctx context.Context) (*kf.GetUpgradeServiceConfigResponse, error) {
	return client.GetAndUnmarshal[kf.GetUpgradeServiceConfigResponse](s.client, ctx, FCustomerGetUpgradeServiceConfigURL, url.Values{})
}
...
func (s *Service) UpgradeService(ctx context.Context, req *kf.UpgradeServiceRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, FCustomerUpgradeServiceURL, req)
	return err
}
...
func (s *Service) CancelUpgradeService(ctx context.Context, req *kf.CancelUpgradeServiceRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, FCustomerCancelUpgradeServiceURL, req)
	return err
}
