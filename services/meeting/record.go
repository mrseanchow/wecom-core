...
const (
	EetingRecordDeleteFileURL = "/cgi-bin/meeting/record/delete_file"
	EetingRecordDeleteURL = "/cgi-bin/meeting/record/delete"
	EetingRecordGetFileListURL = "/cgi-bin/meeting/record/get_file_list"
	EetingRecordGetFileURL = "/cgi-bin/meeting/record/get_file"
	EetingRecordGetStatisticsURL = "/cgi-bin/meeting/record/get_statistics"
	EetingRecordListURL = "/cgi-bin/meeting/record/list"
	EetingRecordTranscriptGetDetailURL = "/cgi-bin/meeting/record/transcript/get_detail"
	EetingRecordTranscriptGetParagraphListURL = "/cgi-bin/meeting/record/transcript/get_paragraph_list"
	EetingRecordTranscriptSearchURL = "/cgi-bin/meeting/record/transcript/search"
	EetingRecordUpdateSharingConfigURL = "/cgi-bin/meeting/record/update_sharing_config"
	EetingVipBatchAddJobResultURL = "/cgi-bin/meeting/vip/batch_add_job_result"
	EetingVipBatchDelJobResultURL = "/cgi-bin/meeting/vip/batch_del_job_result"
	EetingVipListURL = "/cgi-bin/meeting/vip/list"
	EetingVipSubmitBatchAddJobURL = "/cgi-bin/meeting/vip/submit_batch_add_job"
	EetingVipSubmitBatchDelJobURL = "/cgi-bin/meeting/vip/submit_batch_del_job"
)
...
func (s *Service) UpdateSharingConfig(ctx context.Context, req *meeting.UpdateSharingConfigRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, EetingRecordUpdateSharingConfigURL, req)
	return err
}
...
func (s *Service) SubmitBatchAddVIP(ctx context.Context, req *meeting.SubmitBatchAddVIPRequest) (*meeting.SubmitBatchAddVIPResponse, error) {
	return client.PostAndUnmarshal[meeting.SubmitBatchAddVIPResponse](s.client, ctx, EetingVipSubmitBatchAddJobURL, req)
}
...
func (s *Service) BatchAddJobResult(ctx context.Context, req *meeting.BatchAddJobResultRequest) (*meeting.BatchAddJobResultResponse, error) {
	return client.PostAndUnmarshal[meeting.BatchAddJobResultResponse](s.client, ctx, EetingVipBatchAddJobResultURL, req)
}
...
func (s *Service) SubmitBatchDelVIP(ctx context.Context, req *meeting.SubmitBatchDelVIPRequest) (*meeting.SubmitBatchDelVIPResponse, error) {
	return client.PostAndUnmarshal[meeting.SubmitBatchDelVIPResponse](s.client, ctx, EetingVipSubmitBatchDelJobURL, req)
}
...
func (s *Service) BatchDelJobResult(ctx context.Context, req *meeting.BatchDelJobResultRequest) (*meeting.BatchDelJobResultResponse, error) {
	return client.PostAndUnmarshal[meeting.BatchDelJobResultResponse](s.client, ctx, EetingVipBatchDelJobResultURL, req)
}
...
func (s *Service) GetVIPList(ctx context.Context, req *meeting.GetVIPListRequest) (*meeting.GetVIPListResponse, error) {
	return client.PostAndUnmarshal[meeting.GetVIPListResponse](s.client, ctx, EetingVipListURL, req)
}
...
func (s *Service) DeleteMeetingRecord(ctx context.Context, req *meeting.DeleteMeetingRecordRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, EetingRecordDeleteURL, req)
	return err
}
...
func (s *Service) DeleteRecordFile(ctx context.Context, req *meeting.DeleteRecordFileRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, EetingRecordDeleteFileURL, req)
	return err
}
...
func (s *Service) GetRecordList(ctx context.Context, req *meeting.GetRecordListRequest) (*meeting.GetRecordListResponse, error) {
	return client.PostAndUnmarshal[meeting.GetRecordListResponse](s.client, ctx, EetingRecordListURL, req)
}
...
func (s *Service) GetFileList(ctx context.Context, req *meeting.GetFileListRequest) (*meeting.GetFileListResponse, error) {
	return client.PostAndUnmarshal[meeting.GetFileListResponse](s.client, ctx, EetingRecordGetFileListURL, req)
}
...
func (s *Service) GetRecordFile(ctx context.Context, req *meeting.GetRecordFileRequest) (*meeting.GetRecordFileResponse, error) {
	return client.PostAndUnmarshal[meeting.GetRecordFileResponse](s.client, ctx, EetingRecordGetFileURL, req)
}
...
func (s *Service) GetStatistics(ctx context.Context, req *meeting.GetStatisticsRequest) (*meeting.GetStatisticsResponse, error) {
	return client.PostAndUnmarshal[meeting.GetStatisticsResponse](s.client, ctx, EetingRecordGetStatisticsURL, req)
}
...
func (s *Service) TranscriptSearch(ctx context.Context, req *meeting.TranscriptSearchRequest) (*meeting.TranscriptSearchResponse, error) {
	return client.PostAndUnmarshal[meeting.TranscriptSearchResponse](s.client, ctx, EetingRecordTranscriptSearchURL, req)
}
...
func (s *Service) GetTranscriptParagraphList(ctx context.Context, req *meeting.GetTranscriptParagraphListRequest) (*meeting.GetTranscriptParagraphListResponse, error) {
	return client.PostAndUnmarshal[meeting.GetTranscriptParagraphListResponse](s.client, ctx, EetingRecordTranscriptGetParagraphListURL, req)
}
...
func (s *Service) GetTranscriptDetail(ctx context.Context, req *meeting.GetTranscriptDetailRequest) (*meeting.GetTranscriptDetailResponse, error) {
	return client.PostAndUnmarshal[meeting.GetTranscriptDetailResponse](s.client, ctx, EetingRecordTranscriptGetDetailURL, req)
}
