...
const (
	XmailUseroptionGetURL = "/cgi-bin/exmail/useroption/get"
	XmailUseroptionUpdateURL = "/cgi-bin/exmail/useroption/update"
)
...
func (s *Service) GetUserOption(ctx context.Context, req *email.GetUserOptionRequest) (*email.GetUserOptionResponse, error) {
	return client.PostAndUnmarshal[email.GetUserOptionResponse](s.client, ctx, XmailUseroptionGetURL, req)
}
...
func (s *Service) UpdateUserOption(ctx context.Context, req *email.UpdateUserOptionRequest) (*email.UpdateUserOptionResponse, error) {
	return client.PostAndUnmarshal[email.UpdateUserOptionResponse](s.client, ctx, XmailUseroptionUpdateURL, req)
}
