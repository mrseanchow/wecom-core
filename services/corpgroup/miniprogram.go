...
const (
	IniprogramTransferSessionURL = "/cgi-bin/miniprogram/transfer_session"
)
...
func (s *Service) TransferSession(ctx context.Context, req *corpgroup.TransferSessionRequest) (*corpgroup.TransferSessionResponse, error) {
	return client.PostAndUnmarshal[corpgroup.TransferSessionResponse](s.client, ctx, IniprogramTransferSessionURL, req)
}
