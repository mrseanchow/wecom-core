...
const (
	XternalcontactGroupchatOnjobTransferURL = "/cgi-bin/externalcontact/groupchat/onjob_transfer"
	XternalcontactTransferCustomerURL = "/cgi-bin/externalcontact/transfer_customer"
	XternalcontactTransferResultURL = "/cgi-bin/externalcontact/transfer_result"
)
...
func (s *Service) OnJobTransferCustomer(ctx context.Context, req *externalcontact.OnJobTransferCustomerRequest) (*externalcontact.OnJobTransferCustomerResponse, error) {
	return client.PostAndUnmarshal[externalcontact.OnJobTransferCustomerResponse](s.client, ctx, XternalcontactTransferCustomerURL, req)
}
...
func (s *Service) OnJobTransferGroupChat(ctx context.Context, req *externalcontact.OnJobTransferGroupChatRequest) (*externalcontact.OnJobTransferGroupChatResponse, error) {
	return client.PostAndUnmarshal[externalcontact.OnJobTransferGroupChatResponse](s.client, ctx, XternalcontactGroupchatOnjobTransferURL, req)
}
...
func (s *Service) GetTransferResult(ctx context.Context, req *externalcontact.TransferResultRequest) (*externalcontact.TransferResultResponse, error) {
	return client.PostAndUnmarshal[externalcontact.TransferResultResponse](s.client, ctx, XternalcontactTransferResultURL, req)
}
