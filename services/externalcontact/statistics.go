...
const (
	XternalcontactGetUserBehaviorDataURL = "/cgi-bin/externalcontact/get_user_behavior_data"
	XternalcontactGroupchatStatisticGroupByDayURL = "/cgi-bin/externalcontact/groupchat/statistic_group_by_day"
	XternalcontactGroupchatStatisticURL = "/cgi-bin/externalcontact/groupchat/statistic"
)
...
func (s *Service) GetGroupChatStatistic(ctx context.Context, req *externalcontact.GroupChatStatisticRequest) (*externalcontact.GroupChatStatisticResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GroupChatStatisticResponse](s.client, ctx, XternalcontactGroupchatStatisticURL, req)
}
...
func (s *Service) GetGroupChatStatisticGroupByDay(ctx context.Context, req *externalcontact.GroupChatStatisticGroupByDayRequest) (*externalcontact.GroupChatStatisticGroupByDayResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GroupChatStatisticGroupByDayResponse](s.client, ctx, XternalcontactGroupchatStatisticGroupByDayURL, req)
}
...
func (s *Service) GetUserBehaviorData(ctx context.Context, req *externalcontact.GetUserBehaviorDataRequest) (*externalcontact.GetUserBehaviorDataResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GetUserBehaviorDataResponse](s.client, ctx, XternalcontactGetUserBehaviorDataURL, req)
}
