...
const (
	XternalcontactAddMsgTemplateURL = "/cgi-bin/externalcontact/add_msg_template"
	XternalcontactCancelGroupmsgSendURL = "/cgi-bin/externalcontact/cancel_groupmsg_send"
	XternalcontactGetGroupmsgListV2URL = "/cgi-bin/externalcontact/get_groupmsg_list_v2"
	XternalcontactGetGroupmsgSendResultURL = "/cgi-bin/externalcontact/get_groupmsg_send_result"
	XternalcontactGetGroupmsgTaskURL = "/cgi-bin/externalcontact/get_groupmsg_task"
	XternalcontactGroupWelcomeTemplateAddURL = "/cgi-bin/externalcontact/group_welcome_template/add"
	XternalcontactGroupWelcomeTemplateDelURL = "/cgi-bin/externalcontact/group_welcome_template/del"
	XternalcontactGroupWelcomeTemplateEditURL = "/cgi-bin/externalcontact/group_welcome_template/edit"
	XternalcontactGroupWelcomeTemplateGetURL = "/cgi-bin/externalcontact/group_welcome_template/get"
	XternalcontactRemindGroupmsgSendURL = "/cgi-bin/externalcontact/remind_groupmsg_send"
	XternalcontactSendWelcomeMsgURL = "/cgi-bin/externalcontact/send_welcome_msg"
)
...
func (s *Service) AddMsgTemplate(ctx context.Context, req *externalcontact.AddMsgTemplateRequest) (*externalcontact.AddMsgTemplateResponse, error) {
	return client.PostAndUnmarshal[externalcontact.AddMsgTemplateResponse](s.client, ctx, XternalcontactAddMsgTemplateURL, req)
}
...
func (s *Service) GetGroupMsgListV2(ctx context.Context, req *externalcontact.GetGroupMsgListV2Request) (*externalcontact.GetGroupMsgListV2Response, error) {
	return client.PostAndUnmarshal[externalcontact.GetGroupMsgListV2Response](s.client, ctx, XternalcontactGetGroupmsgListV2URL, req)
}
...
func (s *Service) GetGroupMsgTask(ctx context.Context, req *externalcontact.GetGroupMsgTaskRequest) (*externalcontact.GetGroupMsgTaskResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GetGroupMsgTaskResponse](s.client, ctx, XternalcontactGetGroupmsgTaskURL, req)
}
...
func (s *Service) GetGroupMsgSendResult(ctx context.Context, req *externalcontact.GetGroupMsgSendResultRequest) (*externalcontact.GetGroupMsgSendResultResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GetGroupMsgSendResultResponse](s.client, ctx, XternalcontactGetGroupmsgSendResultURL, req)
}
...
func (s *Service) SendWelcomeMsg(ctx context.Context, req *externalcontact.SendWelcomeMsgRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactSendWelcomeMsgURL, req)
	return err
}
...
func (s *Service) CancelGroupMsgSend(ctx context.Context, req *externalcontact.CancelGroupMsgSendRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactCancelGroupmsgSendURL, req)
	return err
}
...
func (s *Service) RemindGroupMsgSend(ctx context.Context, req *externalcontact.RemindGroupMsgSendRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactRemindGroupmsgSendURL, req)
	return err
}
...
func (s *Service) AddGroupWelcomeTemplate(ctx context.Context, req *externalcontact.AddGroupWelcomeTemplateRequest) (*externalcontact.AddGroupWelcomeTemplateResponse, error) {
	return client.PostAndUnmarshal[externalcontact.AddGroupWelcomeTemplateResponse](s.client, ctx, XternalcontactGroupWelcomeTemplateAddURL, req)
}
...
func (s *Service) EditGroupWelcomeTemplate(ctx context.Context, req *externalcontact.EditGroupWelcomeTemplateRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactGroupWelcomeTemplateEditURL, req)
	return err
}
...
func (s *Service) GetGroupWelcomeTemplate(ctx context.Context, req *externalcontact.GetGroupWelcomeTemplateRequest) (*externalcontact.GetGroupWelcomeTemplateResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GetGroupWelcomeTemplateResponse](s.client, ctx, XternalcontactGroupWelcomeTemplateGetURL, req)
}
...
func (s *Service) DelGroupWelcomeTemplate(ctx context.Context, req *externalcontact.DelGroupWelcomeTemplateRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactGroupWelcomeTemplateDelURL, req)
	return err
}
