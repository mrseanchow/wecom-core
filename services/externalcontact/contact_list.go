...
const (
	XternalcontactContactListURL = "/cgi-bin/externalcontact/contact_list"
)
...
func (s *Service) GetContactList(ctx context.Context, req *externalcontact.GetContactListRequest) (*externalcontact.GetContactListResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GetContactListResponse](s.client, ctx, XternalcontactContactListURL, req)
}
