...
const (
	XternalcontactGetFollowUserListURL = "/cgi-bin/externalcontact/get_follow_user_list"
)
...
func (s *Service) GetFollowUserList(ctx context.Context) (*externalcontact.GetFollowUserListResponse, error) {
	return client.GetAndUnmarshal[externalcontact.GetFollowUserListResponse](s.client, ctx, XternalcontactGetFollowUserListURL, nil)
}
