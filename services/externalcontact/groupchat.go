...
const (
	XternalcontactGroupchatAddJoinWayURL = "/cgi-bin/externalcontact/groupchat/add_join_way"
	XternalcontactGroupchatDelJoinWayURL = "/cgi-bin/externalcontact/groupchat/del_join_way"
	XternalcontactGroupchatGetJoinWayURL = "/cgi-bin/externalcontact/groupchat/get_join_way"
	XternalcontactGroupchatGetURL = "/cgi-bin/externalcontact/groupchat/get"
	XternalcontactGroupchatListURL = "/cgi-bin/externalcontact/groupchat/list"
	XternalcontactGroupchatTransferURL = "/cgi-bin/externalcontact/groupchat/transfer"
	XternalcontactGroupchatUpdateJoinWayURL = "/cgi-bin/externalcontact/groupchat/update_join_way"
	XternalcontactOpengidToChatidURL = "/cgi-bin/externalcontact/opengid_to_chatid"
)
...
func (s *Service) ListGroupChat(ctx context.Context, req *externalcontact.ListGroupChatRequest) (*externalcontact.ListGroupChatResponse, error) {
	return client.PostAndUnmarshal[externalcontact.ListGroupChatResponse](s.client, ctx, XternalcontactGroupchatListURL, req)
}
...
func (s *Service) GetGroupChat(ctx context.Context, req *externalcontact.GetGroupChatRequest) (*externalcontact.GetGroupChatResponse, error) {
	return client.PostAndUnmarshal[externalcontact.GetGroupChatResponse](s.client, ctx, XternalcontactGroupchatGetURL, req)
}
...
func (s *Service) OpenGIDToChatID(ctx context.Context, req *externalcontact.OpenGIDToChatIDRequest) (*externalcontact.OpenGIDToChatIDResponse, error) {
	return client.PostAndUnmarshal[externalcontact.OpenGIDToChatIDResponse](s.client, ctx, XternalcontactOpengidToChatidURL, req)
}
...
func (s *Service) TransferGroupChat(ctx context.Context, req *externalcontact.TransferGroupChatRequest) (*externalcontact.TransferGroupChatResponse, error) {
	return client.PostAndUnmarshal[externalcontact.TransferGroupChatResponse](s.client, ctx, XternalcontactGroupchatTransferURL, req)
}
...
func (s *Service) AddJoinWay(ctx context.Context, req *externalcontact.AddJoinWayRequest) (*externalcontact.AddJoinWayResponse, error) {
	return client.PostAndUnmarshal[externalcontact.AddJoinWayResponse](s.client, ctx, XternalcontactGroupchatAddJoinWayURL, req)
}
...
func (s *Service) GetJoinWay(ctx context.Context, configID string) (*externalcontact.GetJoinWayResponse, error) {
	...
	return client.PostAndUnmarshal[externalcontact.GetJoinWayResponse](s.client, ctx, XternalcontactGroupchatGetJoinWayURL, req)
}
...
func (s *Service) UpdateJoinWay(ctx context.Context, req *externalcontact.UpdateJoinWayRequest) error {
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactGroupchatUpdateJoinWayURL, req)
	return err
}
...
func (s *Service) DeleteJoinWay(ctx context.Context, configID string) error {
	...
	_, err := client.PostAndUnmarshal[common.Response](s.client, ctx, XternalcontactGroupchatDelJoinWayURL, req)
	return err
}
