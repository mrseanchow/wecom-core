...
const (
	EssageUpdateTemplateCardURL = "/cgi-bin/message/update_template_card"
)
...
func (s *Service) UpdateTemplateCard(ctx context.Context, req *message.UpdateTemplateCardRequest) (*message.UpdateTemplateCardResponse, error) {
	return client.PostAndUnmarshal[message.UpdateTemplateCardResponse](s.client, ctx, EssageUpdateTemplateCardURL, req)
}
