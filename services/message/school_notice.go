...
const (
	XternalcontactMessageSendURL = "/cgi-bin/externalcontact/message/send"
)
...
func (s *Service) SendSchoolNotice(ctx context.Context, req *message.SendSchoolNoticeRequest) (*message.SendSchoolNoticeResponse, error) {
	return client.PostAndUnmarshal[message.SendSchoolNoticeResponse](s.client, ctx, XternalcontactMessageSendURL, req)
}
