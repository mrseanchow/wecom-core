...
const (
	EcurityGetScreenOperRecordURL = "/cgi-bin/security/get_screen_oper_record"
)
...
func (s *Service) GetScreenOperRecord(ctx context.Context, req *security.GetScreenOperRecordRequest) (*security.GetScreenOperRecordResponse, error) {
	return client.PostAndUnmarshal[security.GetScreenOperRecordResponse](s.client, ctx, EcurityGetScreenOperRecordURL, req)
}
