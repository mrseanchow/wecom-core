...
const (
	EcurityMemberOperLogListURL = "/cgi-bin/security/member_oper_log/list"
)
...
func (s *Service) ListMemberOperLog(ctx context.Context, req *security.ListMemberOperLogRequest) (*security.ListMemberOperLogResponse, error) {
	return client.PostAndUnmarshal[security.ListMemberOperLogResponse](s.client, ctx, EcurityMemberOperLogListURL, req)
}
