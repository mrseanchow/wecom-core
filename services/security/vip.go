...
const (
	EcurityVipBatchAddJobResultURL = "/cgi-bin/security/vip/batch_add_job_result"
	EcurityVipBatchDelJobResultURL = "/cgi-bin/security/vip/batch_del_job_result"
	EcurityVipListURL = "/cgi-bin/security/vip/list"
	EcurityVipSubmitBatchAddJobURL = "/cgi-bin/security/vip/submit_batch_add_job"
	EcurityVipSubmitBatchDelJobURL = "/cgi-bin/security/vip/submit_batch_del_job"
)
...
func (s *Service) SubmitBatchAddVIPJob(ctx context.Context, req *security.SubmitBatchAddVIPJobRequest) (*security.SubmitBatchAddVIPJobResponse, error) {
	return client.PostAndUnmarshal[security.SubmitBatchAddVIPJobResponse](s.client, ctx, EcurityVipSubmitBatchAddJobURL, req)
}
...
func (s *Service) BatchAddVIPJobResult(ctx context.Context, req *security.BatchAddVIPJobResultRequest) (*security.BatchAddVIPJobResultResponse, error) {
	return client.PostAndUnmarshal[security.BatchAddVIPJobResultResponse](s.client, ctx, EcurityVipBatchAddJobResultURL, req)
}
...
func (s *Service) SubmitBatchDelVIPJob(ctx context.Context, req *security.SubmitBatchDelVIPJobRequest) (*security.SubmitBatchDelVIPJobResponse, error) {
	return client.PostAndUnmarshal[security.SubmitBatchDelVIPJobResponse](s.client, ctx, EcurityVipSubmitBatchDelJobURL, req)
}
...
func (s *Service) BatchDelVIPJobResult(ctx context.Context, req *security.BatchDelVIPJobResultRequest) (*security.BatchDelVIPJobResultResponse, error) {
	return client.PostAndUnmarshal[security.BatchDelVIPJobResultResponse](s.client, ctx, EcurityVipBatchDelJobResultURL, req)
}
...
func (s *Service) ListVIP(ctx context.Context, req *security.ListVIPRequest) (*security.ListVIPResponse, error) {
	return client.PostAndUnmarshal[security.ListVIPResponse](s.client, ctx, EcurityVipListURL, req)
}
