...
const (
	DconvertConvertTmpExternalUseridURL = "/cgi-bin/idconvert/convert_tmp_external_userid"
)
...
func (s *Service) ConvertTmpExternalUserID(ctx context.Context, req *contact.ConvertTmpExternalUserIDRequest) (*contact.ConvertTmpExternalUserIDResponse, error) {
	return client.PostAndUnmarshal[contact.ConvertTmpExternalUserIDResponse](s.client, ctx, DconvertConvertTmpExternalUseridURL, req)
}
