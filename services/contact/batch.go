...
const (
	AtchGetresultURL = "/cgi-bin/batch/getresult"
	AtchReplacepartyURL = "/cgi-bin/batch/replaceparty"
	AtchReplaceuserURL = "/cgi-bin/batch/replaceuser"
	AtchSyncuserURL = "/cgi-bin/batch/syncuser"
)
...
func (s *Service) SyncUsers(ctx context.Context, req *contact.SyncUsersRequest) (string, error) {
	result, err := client.PostAndUnmarshal[contact.SyncUsersResponse](s.client, ctx, AtchSyncuserURL, req)
	if err != nil {
		return "", err
	}
...
func (s *Service) ReplaceUsers(ctx context.Context, req *contact.ReplaceUsersRequest) (string, error) {
	result, err := client.PostAndUnmarshal[contact.ReplaceUsersResponse](s.client, ctx, AtchReplaceuserURL, req)
	if err != nil {
		return "", err
	}
...
func (s *Service) ReplaceDepartments(ctx context.Context, req *contact.ReplaceDepartmentsRequest) (string, error) {
	result, err := client.PostAndUnmarshal[contact.ReplaceDepartmentsResponse](s.client, ctx, AtchReplacepartyURL, req)
	if err != nil {
		return "", err
	}
...
func (s *Service) GetBatchResult(ctx context.Context, jobID string) (*contact.GetBatchResultResponse, error) {
	...
	return client.GetAndUnmarshal[contact.GetBatchResultResponse](s.client, ctx, AtchGetresultURL, query)
}
