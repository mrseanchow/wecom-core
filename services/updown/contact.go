...
const (
	OrpgroupImportChainContactURL = "/cgi-bin/corpgroup/import_chain_contact"
)
...
func (s *Service) ImportChainContact(ctx context.Context, req *updown.ImportChainContactRequest) (string, error) {
	result, err := client.PostAndUnmarshal[updown.ImportChainContactResponse](s.client, ctx, OrpgroupImportChainContactURL, req)
	if err != nil {
		return "", err
	}
