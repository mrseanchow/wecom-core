...
const (
	OrpgroupBatchExternalUseridToPendingIdURL = "/cgi-bin/corpgroup/batch/external_userid_to_pending_id"
	OrpgroupUnionidToExternalUseridURL = "/cgi-bin/corpgroup/unionid_to_external_userid"
	OrpgroupUnionidToPendingIdURL = "/cgi-bin/corpgroup/unionid_to_pending_id"
)
...
func (s *Service) UnionIDToExternalUserID(ctx context.Context, req *updown.UnionIDToExternalUserIDRequest) ([]updown.ExternalUserIDInfo, error) {
	result, err := client.PostAndUnmarshal[updown.UnionIDToExternalUserIDResponse](s.client, ctx, OrpgroupUnionidToExternalUseridURL, req)
	if err != nil {
		return nil, err
	}
...
func (s *Service) UnionIDToPendingID(ctx context.Context, req *updown.UnionIDToPendingIDRequest) (string, error) {
	result, err := client.PostAndUnmarshal[updown.UnionIDToPendingIDResponse](s.client, ctx, OrpgroupUnionidToPendingIdURL, req)
	if err != nil {
		return "", err
	}
...
func (s *Service) ExternalUserIDToPendingID(ctx context.Context, req *updown.ExternalUserIDToPendingIDRequest) ([]updown.PendingIDResult, error) {
	result, err := client.PostAndUnmarshal[updown.ExternalUserIDToPendingIDResponse](s.client, ctx, OrpgroupBatchExternalUseridToPendingIdURL, req)
	if err != nil {
		return nil, err
	}
