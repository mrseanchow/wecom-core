...
const (
	OrpgroupCorpListAppShareInfoURL = "/cgi-bin/corpgroup/corp/list_app_share_info"
)
...
func (s *Service) ListAppShareInfo(ctx context.Context, req *updown.ListAppShareInfoRequest) (*updown.ListAppShareInfoResponse, error) {
	return client.PostAndUnmarshal[updown.ListAppShareInfoResponse](s.client, ctx, OrpgroupCorpListAppShareInfoURL, req)
}
