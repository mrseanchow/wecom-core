...
const (
	OrpgroupRuleAddRuleURL = "/cgi-bin/corpgroup/rule/add_rule"
	OrpgroupRuleDeleteRuleURL = "/cgi-bin/corpgroup/rule/delete_rule"
	OrpgroupRuleGetRuleInfoURL = "/cgi-bin/corpgroup/rule/get_rule_info"
	OrpgroupRuleListIdsURL = "/cgi-bin/corpgroup/rule/list_ids"
	OrpgroupRuleModifyRuleURL = "/cgi-bin/corpgroup/rule/modify_rule"
)
...
func (s *Service) AddRule(ctx context.Context, req *updown.AddRuleRequest) (int64, error) {
	result, err := client.PostAndUnmarshal[updown.AddRuleResponse](s.client, ctx, OrpgroupRuleAddRuleURL, req)
	if err != nil {
		return 0, err
	}
...
func (s *Service) ModifyRule(ctx context.Context, req *updown.ModifyRuleRequest) error {
	_, err := client.PostAndUnmarshal[updown.ModifyRuleResponse](s.client, ctx, OrpgroupRuleModifyRuleURL, req)
	return err
}
...
func (s *Service) DeleteRule(ctx context.Context, req *updown.DeleteRuleRequest) error {
	_, err := client.PostAndUnmarshal[updown.DeleteRuleResponse](s.client, ctx, OrpgroupRuleDeleteRuleURL, req)
	return err
}
...
func (s *Service) ListRuleIDs(ctx context.Context, req *updown.ListRuleIDsRequest) ([]int64, error) {
	result, err := client.PostAndUnmarshal[updown.ListRuleIDsResponse](s.client, ctx, OrpgroupRuleListIdsURL, req)
	if err != nil {
		return nil, err
	}
...
func (s *Service) GetRuleInfo(ctx context.Context, req *updown.GetRuleInfoRequest) (*updown.RuleInfo, error) {
	result, err := client.PostAndUnmarshal[updown.GetRuleInfoResponse](s.client, ctx, OrpgroupRuleGetRuleInfoURL, req)
	if err != nil {
		return nil, err
	}
